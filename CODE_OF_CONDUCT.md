...
as its code of conduct. The full text is available at the link above and is incorporated here by reference.
...
see the canonical document linked above.

## Scope

This Code of Conduct applies within all project spaces — issues, pull requests, discussions,
and any other forum where someone is representing the project or its community.
