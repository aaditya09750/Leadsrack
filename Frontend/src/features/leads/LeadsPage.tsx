  ...
  return (
    <>
      <div className="px-7 pt-7 pb-4 flex items-center justify-between">
        <div>
          <h1 className="text-primary text-base font-semibold">Leads</h1>
      ...
      {isLoading ? (
        <div className="px-7">
          <div className="rounded-xl border border-border bg-white/5 py-12 flex justify-center">
        ...
        <div className="px-7 mt-4 flex items-center justify-between text-xs text-secondary">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1 px-2 py-1 rounded-lg border border-border hover:bg-white/5 disabled:opacity-40 disabled:cursor-not-allowed"
            >
              <ChevronLeft size={14} />
              Prev
            </button>
